...
export function InsightCard({ label, value, hint, icon, tone = "primary", className }: Props) {
  const toneClass =
    tone === "success"
  ...
  return (
    <div className={cn("glass hover-lift relative overflow-hidden rounded-2xl p-5", className)}>
